...
def chunk_documents_for_rerank(
    ...
    try:
        from weave_core.utils import TiktokenTokenizer
...
async def cohere_rerank(
    ...
    """
    if api_key is None:
        api_key = os.getenv("WEAVE_COHERE_API_KEY") or os.getenv("WEAVE_RERANK_BINDING_API_KEY")
...
async def jina_rerank(
    ...
    """
    if api_key is None:
        api_key = os.getenv("WEAVE_JINA_API_KEY") or os.getenv("WEAVE_RERANK_BINDING_API_KEY")
...
async def ali_rerank(
    ...
    """
    if api_key is None:
        api_key = os.getenv("WEAVE_DASHSCOPE_API_KEY") or os.getenv("WEAVE_RERANK_BINDING_API_KEY")
...
python -m weave_core.llm.rerank
"""
