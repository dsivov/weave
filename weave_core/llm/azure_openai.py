...
All core logic for both OpenAI and Azure OpenAI now lives in weave_core.llm.openai,
with this module serving as a thin compatibility wrapper for existing code that
imports from weave_core.llm.azure_openai.
"""

from weave_core.llm.openai import (
