...
from weave_core.exceptions import PipelineNotInitializedError
...
def direct_log(message, enable_output: bool = True, level: str = "DEBUG"):
    ...
    # Get the current logger level from the weave_core logger
    try:
        from weave_core.utils import logger

        current_level = logger.getEffectiveLevel()
    except ImportError:
        # Fallback if weave_core.utils is not available
