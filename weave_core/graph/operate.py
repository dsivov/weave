...
from weave_core.exceptions import (
...
async def _handle_single_relationship_extraction(
    ...
    # Accept 5-field (standard) and 6-field (Weave, with a trailing
    # RelationContext JSON) relation records. Accepting 6 here is what lets the
    # graph-rebuild path (e.g. after document deletion) preserve Weave relations
    ...
    try:
        ...
        # Weave: a 6th field carries a RelationContext JSON object.
...
async def _merge_edges_then_upsert(
    ...
    # Collect and merge relation context (Weave quadruple rc component).
    # For standard WeaveEngine edges without relation_context this returns None and
...
async def _apply_token_truncation(
    ...
    for i, relation in enumerate(final_relations):
        ...
        # Parse relation_context (Weave quadruple rc field) if present
...
def _build_annotated_chunk(
    ...
    if chunk_entities or chunk_relations:
        ...
        for r in chunk_relations:
            ...
            # Surface relation_context (Weave quadruple rc) if present
