...
from weave_core.graph.base import DeletionResult
from weave_core.store.locks import get_storage_keyed_lock
from weave_core.constants import GRAPH_FIELD_SEP
from weave_core.utils import compute_mdhash_id, logger
from weave_core.graph.base import StorageNameSpace
    ...
    async with get_storage_keyed_lock(
        ...
        try:
            ...
            if relation_chunks_storage is not None and edges:
                ...
                from weave_core.utils import make_relation_chunk_key
...
async def _edit_entity_impl(
    ...
    *,
    ...
    if entity_chunks_storage is not None or relation_chunks_storage is not None:
        from weave_core.utils import make_relation_chunk_key, compute_incremental_chunk_ids
