...
class Neo4JStorage(BaseGraphStorage):
    ...
    def __init__(self, namespace, global_config, embedding_func, workspace=None):
        ...
        neo4j_workspace = os.environ.get("WEAVE_NEO4J_WORKSPACE")
