...
class OllamaServerInfos:
    def __init__(self, name=None, tag=None):
        self._weave_name = name or os.getenv(
            "WEAVE_OLLAMA_EMULATING_MODEL_NAME", DEFAULT_OLLAMA_MODEL_NAME
        )
        self._weave_tag = tag or os.getenv(
            "WEAVE_OLLAMA_EMULATING_MODEL_TAG", DEFAULT_OLLAMA_MODEL_TAG
        )
        self.WEAVE_SIZE = DEFAULT_OLLAMA_MODEL_SIZE
        self.WEAVE_CREATED_AT = DEFAULT_OLLAMA_CREATED_AT
        self.WEAVE_DIGEST = DEFAULT_OLLAMA_DIGEST

    @property
    def WEAVE_NAME(self):
        return self._weave_name

    @WEAVE_NAME.setter
    def WEAVE_NAME(self, value):
        self._weave_name = value

    @property
    def WEAVE_TAG(self):
        return self._weave_tag

    @WEAVE_TAG.setter
    def WEAVE_TAG(self, value):
        self._weave_tag = value

    @property
    def WEAVE_MODEL(self):
        return f"{self._weave_name}:{self._weave_tag}"
...
@dataclass
class QueryParam:
    """Configuration parameters for query execution in WeaveEngine."""
    ...
    top_k: int = int(os.getenv("WEAVE_TOP_K", str(DEFAULT_TOP_K)))
    """Number of top items to retrieve. Represents entities in 'local' mode and relationships in 'global' mode."""

    chunk_top_k: int = int(os.getenv("WEAVE_CHUNK_TOP_K", str(DEFAULT_CHUNK_TOP_K)))
    """Number of text chunks to retrieve initially from vector search and keep after reranking.
    If None, defaults to top_k value.
    """

    max_entity_tokens: int = int(
        os.getenv("WEAVE_MAX_ENTITY_TOKENS", str(DEFAULT_MAX_ENTITY_TOKENS))
    )
    """Maximum number of tokens allocated for entity context in unified token control system."""

    max_relation_tokens: int = int(
        os.getenv("WEAVE_MAX_RELATION_TOKENS", str(DEFAULT_MAX_RELATION_TOKENS))
    )
    """Maximum number of tokens allocated for relationship context in unified token control system."""

    max_total_tokens: int = int(
        os.getenv("WEAVE_MAX_TOTAL_TOKENS", str(DEFAULT_MAX_TOTAL_TOKENS))
    )
    ...
    history_turns: int = int(os.getenv("WEAVE_HISTORY_TURNS", str(DEFAULT_HISTORY_TURNS)))
    ...
    context_format: Literal["annotated", "legacy"] = os.getenv(
        "WEAVE_CONTEXT_FORMAT", "annotated"
    )
    ...
    enable_rerank: bool = os.getenv("WEAVE_RERANK_BY_DEFAULT", "true").lower() == "true"
