...
| # | criterion | verdict |
|---|---|---|
| 1 | every extracted node's type is one the ontology declares, or `Other` | **fail — 55%.** 38 of 76 an ontology type, 4 `Other`, **34 neither** (`concept` 18, `UNKNOWN` 9, `ENTITY` 6, `script` 1). **W47.** |
