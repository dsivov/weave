...
import { loginToServer, getAuthStatus } from '@/api/weave'
...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const previousUsername = localStorage.getItem('WEAVE-PREVIOUS-USER')
      ...
      localStorage.setItem('WEAVE-PREVIOUS-USER', username)
        ...
        <CardHeader className="flex items-center justify-center space-y-2 pb-8 pt-6">
          <div className="flex flex-col items-center space-y-4">
            <div className="flex items-center gap-3">
              <img src="logo.svg" alt="Weave Logo" className="h-12 w-12" />
              <ZapIcon className="size-10 text-emerald-400" aria-hidden="true" />
            </div>
            <div className="text-center space-y-2">
              <h1 className="text-3xl font-bold tracking-tight">Weave</h1>
