...
import { useFlowStore, type NodeShape } from '@/features/next/diagram-editor/lib/store'
import { ShapeIcon, ALL_SHAPES } from '@/features/next/diagram-editor/components/ShapeIcons'
