...
import { getAuthStatus } from '@/api/weave'
    ...
    <ThemeProvider>
      <TabVisibilityProvider>
        {initializing ? (
          ...
          // The "next" shell is the default and the only place Studio/Weave live.
          // A stored `cg-ui=classic` wins over that default, so a browser that
          // once visited ?ui=classic stays on the classic UI until ?ui=next.
          <>
            <AppShell />
