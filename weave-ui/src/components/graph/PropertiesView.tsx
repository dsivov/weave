...
import useWeaveGraph from '@/hooks/useWeaveGraph'
import { useTranslation } from 'react-i18next'
import { GitBranchPlus, Scissors, FileTextIcon } from 'lucide-react'
import EditablePropertyRow from './EditablePropertyRow'
import { getEntityDecisions, getEntityChunks, type EntityDecision, type EntityChunk } from '@/api/weave'
...
const PropertiesView = () => {
  const { getNode, getEdge } = useWeaveGraph()
