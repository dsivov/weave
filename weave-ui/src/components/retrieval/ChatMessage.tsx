  ...
  return (
    ...
    >
      ...
      {/* Main content display.
          The prose class list lives on a wrapper rather than on ReactMarkdown:
          `react-markdown` dropped `className` from its props, and every rule
          here is a descendant selector (`prose`, `[&_.katex]`, …), so they apply
          from a parent exactly as they did from the rendered root. W8. */}
      {finalDisplayContent && (
