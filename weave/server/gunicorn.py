#!/usr/bin/env python
"""
Start WeaveEngine server with Gunicorn
"""
...
def main():
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from weave.server import gunicorn_config
            ...
            host = (
                ...
                else os.getenv("WEAVE_HOST", "0.0.0.0")
            )
            port = (
                global_args.port
                if global_args.port != 9621
                else get_env_value("WEAVE_PORT", 9621, int)
            )
            ...
            gunicorn_config.loglevel = (
                ...
                else os.getenv("WEAVE_LOG_LEVEL", "info")
            )
            ...
            gunicorn_config.timeout = (
                ...
                if global_args.timeout is not None
                    ...
                    "WEAVE_TIMEOUT", DEFAULT_TIMEOUT + 30, int, special_none=True
                )
            )

            # Keepalive configuration
            gunicorn_config.keepalive = get_env_value("WEAVE_KEEPALIVE", 5, int)

            # SSL configuration prioritizes command line arguments
            if global_args.ssl or os.getenv("WEAVE_SSL", "").lower() in (
                "true",
                "1",
                "yes",
                "t",
        ...
        def load(self):
            ...
            from weave.server.app import get_application
    ...
    if workers_count > 1:
        ...
        os.environ["WEAVE_MAIN_PROCESS"] = "1"
