"""
Utility functions for the WeaveEngine API.
"""
...
from weave.server import __api_version__ as api_version
from weave_core import __version__ as core_version
...
def display_splash_screen(args: argparse.Namespace) -> None:
    """
    Display a colorful splash screen showing WeaveEngine server configuration
    ...
    ASCIIColors.yellow(
        f"{get_env_value('WEAVE_FORCE_LLM_SUMMARY_ON_MERGE', DEFAULT_FORCE_LLM_SUMMARY_ON_MERGE, int)}"
    )
