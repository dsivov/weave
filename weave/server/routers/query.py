"""
This module contains all query-related routes for the WeaveEngine API.
"""
...
from weave_core.utils import compute_args_hash, handle_cache, save_to_cache, CacheData, logger
...
async def classify_query_mode(
    ...
    Args:
        ...
        rag: The WeaveEngine/WeaveGraph instance (needs llm_model_func, global_config, full_docs).
    ...
    from weave.server.config import get_env_value

    if get_env_value("WEAVE_AUTO_CATALOG_BYPASS", False, bool):
